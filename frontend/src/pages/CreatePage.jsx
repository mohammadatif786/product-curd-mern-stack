...
const CreatePage = () => {
  ...
  return (
    <Container maxW={"container.sm"}>
      <VStack spacing={8} >
        <Heading as={"h1"} bgGradient={"linear(to-r, cyan.400, blue.500)"} bgClip={"text"} size={"2xl"} textAlign={"center"} mb={8}>
          Create New Product
        </Heading>
        ...
        <Box w={"full"} bg={useColorModeValue("white", "gray.800")} p={6} rounded={"lg"} shadow={"md"}>
          <VStack >
            ...
            <Input placeholder={"Image URI"} name={"image"} value={newProduct.image} onChange={(e) => setNewProduct({ ...newProduct, image: e.target.value })} />
